...
df_missing = pd.read_csv('tables/source_table/segments_missing.csv')
...
df_missing = df_missing.merge(df_base, on='segment_id', how='left').to_csv('tables/prepared/segments_missing.csv', index=False, encoding='utf-8')
